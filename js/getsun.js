...
//         };
// 参照：http://www.lenashane.com/article/20151110-1043.html
// 使用：用于计算已知经纬度和时区的位置日出日落时间
// 其他可参照教程：1）https://github.com/mourner/suncalc 2）https://www.esrl.noaa.gov/gmd/grad/solcalc/ 3）https://answer-id.com/18949074[对1)的补充] 4)http://api.map.baidu.com/lbsapi/getpoint/index.html[百度获取经纬度接口]
////////////////////////////////////////////////////////////////////////////////
...
var res = computeSunRiseSunSet(45.733,126.612,8);
console.log(res.str); //日出 6:48 | 正午 11:54 | 日落 17:01
